 ...
 * that should be used when dealing with the diaplay of elements (via their
 * CSS classes and visibility on screen. It is an API focused on mutating the
 * diaplay and not reading it as no logical state should be encoded in the
 * diaplay of elements.
 */
...
var shouldWrap = {
  ...
  // they will be initialized in the wrong namespace (and will not diaplay).
  'circle': true,
  'defs': true,
  'ellipse': true,
  'g': true,
